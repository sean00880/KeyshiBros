...
const SLIDES = [
  {
    ...
    label: 'Gameplay',
    icon: GameController,
    headline: 'Skill-Based Combat Arena',
    desc: 'Fast-paced PvP battles with ranked matchmaking. Win matches, climb divisions, earn tokens every round.',
    stats: [
      { label: 'Game Modes', value: '5' },
      { label: 'Avg Match', value: '3 min' },
      { label: 'Daily Active', value: '12.5K' },
    ],
  },
  {
    id: 'rewards',
    ...
    desc: 'Every victory earns $KB tokens. Daily challenges, season passes, and streak multipliers amplify your earnings.',
    stats: [
      { label: 'Daily Pool', value: '50K $KB' },
      { label: 'Streak Bonus', value: 'Up to 3x' },
  ...
  },
  {
    ...
    label: 'Tokenomics',
    icon: Coin,
    headline: 'Deflationary By Design',
    desc: '1B total supply with automatic burn mechanics. Revenue buybacks reduce circulating supply every week.',
    stats: [
      { label: 'Supply', value: '1B' },
      { label: 'Burned', value: '12.4M' },
      { label: 'Tax', value: '4% / 4%' },
    ],
    badge: '4% Buy | 4% Sell',
  },
  {
    ...
    label: 'AI + Social',
    icon: ShareNetwork,
    headline: 'MEMELinked Integration',
    desc: 'AI-powered matchmaking and coaching. Social feeds, squad formation, referral loops, and spectator betting.',
    stats: [
      { label: 'Referral Rate', value: '5%' },
      { label: 'AI Coach', value: 'Live' },
      { label: 'Squads', value: '2.1K' },
    ],
  },
  {
    id: 'leaderboards',
    ...
    desc: 'Weekly and seasonal leaderboards. Top 100 players split a massive prize pool every season.',
    stats: [
      { label: 'Season Prize', value: '$50K' },
      { label: 'Players', value: '12,500' },

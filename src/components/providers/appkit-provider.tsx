 ...
 *
 * Combines customWallets (for UI display) + wallet-standard adapters
 * (for actual Phantom/Solflare connection) + WalletConnect (for Trust/OKX).
 *
 * customWallets show in the modal. When tapped:
 * - Phantom/Solflare: wallet-standard handles connection if in wallet browser
 * - Trust/OKX/Backpack: WalletConnect deep link opens app
 */
...
if (typeof window !== 'undefined' && projectId) {
  ...
  createAppKit({
    ...
    // Socials enabled as fallback wallet on mobile Safari
    features: {
      analytics: false,
    },
    allWallets: 'SHOW',
